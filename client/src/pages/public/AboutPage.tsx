  ...
  return (
    <>
      ...
      <div className="space-y-6">
        <div>
          <p className="text-sm uppercase tracking-[0.4em] text-primary/80">About</p>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="text-xl font-semibold text-dark">Key Roles & Experience</h2>
          ...
          <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="text-xl font-semibold text-dark">Areas of Expertise</h2>
        ...
        <section className="rounded-3xl border border-slate-200 bg-gradient-to-br from-primary/10 via-white to-secondary/10 p-8 shadow-inner">

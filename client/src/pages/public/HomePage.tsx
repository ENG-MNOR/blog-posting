...
const HomePage = () => {
    ...
    <>
      ...
      <section className="grid gap-10 md:grid-cols-2 md:items-center py-10">
        ...
        <div className="space-y-5">
          <p className="text-sm uppercase tracking-[0.6em] text-primary/80">
        ...
        <div className="flex justify-center md:justify-end">
          {getImageSrc(homeContent?.profilePhoto) ? (
            ...
            <div className="w-full max-w-md rounded-3xl shadow-lg bg-slate-100 flex items-center justify-center aspect-[3/4]">
      ...
      <section className="mt-10 space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-semibold text-dark">Highlighted Research</h2>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {research?.slice(0, 4).map((item) => (
            <article key={item._id} className="rounded-2xl border border-slate-200 bg-white p-5 shadow">
              ...
              <p className="text-sm text-slate-500">{item.journal}</p>
      ...
      <section className="mt-16 space-y-6 mb-20">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-semibold text-dark">Upcoming Engagements</h2>
  ...
  >
    <div className="flex-1 min-w-0 space-y-1">
      ...
      <h3 className="text-lg font-semibold text-dark">{event.name}</h3>
